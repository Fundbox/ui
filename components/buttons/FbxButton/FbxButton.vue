...
@import "~fbx_common/src/styles/utils/mixins.scss";
@import "~fbx_common/src/styles/utils/variables.scss";
...
.fbx-button-loading {
  ...
  content: "";
  position: absolute;
  background-image: url("~fbx_common/src/assets/images/btn-ajax-loading.gif");
